function applyBitcoinbarData(elem, data) {
	...
	elem.html("<div class='bar'></div><div class='text'>"+balance_btc.toFixed(3)+" BTC <span class='goal'>of "+elem.data("goal")+" BTC</span><br><span class='heart'>&#x2665;</span> <u>Dona bitcoin</u><br>¡Gracias! :)</div>")
